<template>
    <div class="to-block-pd">
        <div class="to-block-pd__wrap">
            <div class="to-block-pd__item" v-for="(item,index) in repeatList" :key="item.id">
                <div class="to-block-pd__title">
                    <div class="to-block-pd__title-name">
                        <to-input v-model="item.title" />
                    </div>
                    <div class="to-block-pd__title-btns">
                ...
                <div class="to-block-cf__field">
                    <div class="form-grid">
                        ...
                        <div class="col-2" v-if="item.key">
                            <to-label>{{ $t('repeater.meta_key') }}</to-label>
                            <to-input-clipboard v-model="item.key" :isReadonly="true" readonly/>
                        </div>
                    </div>
                </div>

                <div class="to-block-cf__field" v-if="item.key">
                    <div class="form-grid">
                        <div class="col-1">
                        ...
                        <div class="col-auto">
                            <to-button :processing="item.applying" type="systems" @click="apply({index, pt: 'thegem_pf_item', title: item.title, key: item.key, value: item.value})">
...
export default addHelpers({
    ...
    methods: {
        ...
        apply(payload) {
            ...
            this.api('applyProjectDetails', payload).then(
                response => {
...
#thegem-options.theme-dark .to-block-pd {
    &__title {
