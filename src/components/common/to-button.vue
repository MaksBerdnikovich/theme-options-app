<template>
    <button type="button"  @mousedown.prevent.stop="" @mouseup.prevent.stop="" v-on:click.stop="click($event)" v-bind:class="classComputed" :disabled="disabled || processing">
...
export default {
    ...
    computed: {
        ...
        classComputed() {
            let classes=['to-btn', 'to-btn-' + this.type];
            if (this.processing) {
