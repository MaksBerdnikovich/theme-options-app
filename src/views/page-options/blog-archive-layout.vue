<template>
    <div>
                ...
                <div class="to-changed-settings">
                    <div class="form-grid">
                        <div class="col-1 col-tb-1">
                            <to-select :value="getOption('blog_archive_item_data.blog_archive_layout_settings')" @input="setOption('blog_archive_item_data.blog_archive_layout_settings',$event)" :options="blogArchiveLayoutSettings"></to-select>
                        </div>
                    </div>
                </div>
            </to-panel-group>
        ...
        <to-panel id="panel.layout" v-if="getOption('blog_archive_item_data.blog_archive_layout_settings') === 'custom'">
            <to-panel-group :label-title="$t('panel.blog_archive_layout_source')">
                <template v-slot:tooltip>
                    <div class="help-tooltip-text">
                        <div class="info">
                            <div v-html="$t('info.archive_pages_blog_archive_layout_source_po')"/>
                        </div>
                    </div>
                </template>
                <div class="to-changed-settings">
                    <div class="form-grid">
                        <div class="col-1">
                            <to-select
                                :value="getOption('blog_archive_item_data.blog_archive_layout_source')"
                                @input="setOption('blog_archive_item_data.blog_archive_layout_source', $event)"
            ...
            <div v-if="getOption('blog_archive_item_data.blog_archive_layout_source') === 'builder'" class="to-panel-separator">
                <to-panel-group :label-title="$t('panel.blog_archive_builder_template')" :class="{'taxonomy-te-edit-link': isTaxonomy}">
                    <template v-slot:tooltip>
                        <div class="help-tooltip-text">
                            <div class="info">
                    ...
                    <div class="to-changed-settings">
                        <div class="form-grid">
                            <div class="col-1">
                                ...
                                <to-select
                                    :value="getOption('blog_archive_item_data.blog_archive_builder_template')"
                                    @input="setOption('blog_archive_item_data.blog_archive_builder_template', $event)"
