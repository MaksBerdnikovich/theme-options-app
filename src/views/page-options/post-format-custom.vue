    ...
    <div>
        <to-panel id="panel.post_format">
            <to-panel-group :label-title="$t('panel.format')">
                ...
                <div v-if="postFormat()==='video'" class="to-post-format-setting-item">
                    <div class="form-grid">
                        <div class="col-2 col-tb-1">
                            ...
                            <to-select :value="getOption('custom_post_item_data.video_type')" @input="setOption('custom_post_item_data.video_type', $event)" :placeholder="$t('video.type_select')" :options="videoTypeList"/>
                        </div>
                        <div class="col-2 col-tb-1">
                            <to-label>{{ $t('video.aspect_ratio') }}</to-label>
                            <to-input :value="getOption('custom_post_item_data.video_aspect_ratio')" @input="setOption('custom_post_item_data.video_aspect_ratio', $event)"/>
                        </div>
                    </div>

                    <div class="form-grid">
                        <div class="col-2 col-tb-1" v-if="getOption('custom_post_item_data.video_type') !== 'self'">
                            <to-label>{{ $t('video.link') }}</to-label>
                            <to-input :value="getOption('custom_post_item_data.video')" @input="setOption('custom_post_item_data.video', $event)"/>
                        </div>
                        <div class="col-2 col-tb-1" v-if="getOption('custom_post_item_data.video_type') === 'self'">
                            <to-label>{{ $t('video.self_link') }}</to-label>
                            <to-input-button-group :value="getOption('custom_post_item_data.video')" @input="setOption('custom_post_item_data.video', $event)" type="video"/>
                        </div>
                        <div class="col-2 col-tb-1" v-if="getOption('custom_post_item_data.video_type') === 'self'">
                            <to-label>{{ $t('video.poster') }}</to-label>
                            <to-input-button-group :value="getOption('custom_post_item_data.video_poster')" @input="setOption('custom_post_item_data.video_poster', $event)" type="image"/>
                        </div>
                        <div class="col-2 col-tb-1">
                            <to-label>{{ $t('video.start') }}</to-label>
                            <to-select :value="getOption('custom_post_item_data.video_start')" @input="setOption('custom_post_item_data.video_start', $event)" :options="videoStart"/>
                        </div>
                        <div class="col-2 col-tb-2">
                            <to-label>{{ $t('video.play_on_mobile') }}</to-label>
                            <to-switch :value="getOption('custom_post_item_data.video_play_on_mobile')" @input="setOption('custom_post_item_data.video_play_on_mobile', $event)"></to-switch>
                        </div>
                        <div class="col-2 col-tb-2">
                            <to-color-picker :label-title="$t('video.overlay')" :value="getOption('custom_post_item_data.video_overlay')" @input="setOption('custom_post_item_data.video_overlay', $event)"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-grid">
                        <div class="col-1">
                            ...
                            <div class="to-input-button-group">
                                <to-input :value="getOption('custom_post_item_data.audio')" @input="setOption('custom_post_item_data.audio', $event)"/>
                                <to-file-select-button :value="getOption('custom_post_item_data.audio')" @input="setOption('custom_post_item_data.audio', $event)" :popup-title="$t('general.select_audio')" :popup-button-title="$t('general.use_audio')" type="audio"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="postFormat()==='quote'" class="to-post-format-setting-item">
                    <div class="form-grid">
                        <div class="col-1">
                            <to-wysiwyg :value="getOption('custom_post_item_data.quote_text')" @input="setOption('custom_post_item_data.quote_text',$event)" :height="'120px'"></to-wysiwyg>
                        </div>
                    </div>
                    <div class="form-grid">
                        <div class="col-1">
                            <to-label>{{ $t('settings.quote_author') }}</to-label>
                            <to-input :value="getOption('custom_post_item_data.quote_author')" @input="setOption('custom_post_item_data.quote_author',$event)"></to-input>
                        </div>
                    </div>
                    <div class="form-grid">
                        <div class="col-4 col-tb-2">
                            <to-color-picker :value="getOption('custom_post_item_data.quote_background')" @input="setOption('custom_post_item_data.quote_background',$event)" :label-title="$t('colors.background_color')"/>
                        </div>
                        <div class="col-4 col-tb-2">
                            <to-color-picker :value="getOption('custom_post_item_data.quote_author_color')" @input="setOption('custom_post_item_data.quote_author_color',$event)" :label-title="$t('colors.author_color')"/>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="postFormat()==='gallery'" class="to-post-format-setting-item">
                    <div class="form-grid">
                        <div class="col-1">
                            ...
                            <to-select :value="getOption('custom_post_item_data.gallery')" @input="setOption('custom_post_item_data.gallery',$event)" :options="galleryList" v-on:right-button-clicked="showPreview($event)"></to-select>
                        </div>
                    </div>
                    <div class="form-grid">
                        <div class="col-1">
                            <to-label>{{ $t('settings.gallery_autoscroll') }}</to-label>
                            <to-input :value="getOption('custom_post_item_data.gallery_autoscroll')" @input="setOption('custom_post_item_data.gallery_autoscroll',$event)"></to-input>
                        </div>
                    </div>
                </div>
            </to-panel-group>
            ...
            <to-panel-group :label-title="$t('panel.featured_post')">
                ...
                <to-switch trueValue="1" falseValue="0" :value="getOption('custom_post_item_data.show_featured_posts_slider')" @input="setOption('custom_post_item_data.show_featured_posts_slider', $event)"/>
            </to-panel-group>
        </to-panel>
        ...
        <to-panel id="panel.appearance_grid_list">
            ...
            <to-panel-group :label-title="$t('panel.highlighted_post')">
                ...
                <to-switch trueValue="1" falseValue="0" :value="getOption('custom_post_item_data.highlight')" @input="setOption('custom_post_item_data.highlight', $event)"/>
            </to-panel-group>

            <div v-if="getOption('custom_post_item_data.highlight') == 1" class="to-panel-separator">
                <to-panel-group :label-title="$t('panel.highlight_type')">
                    ...
                    <to-radio-icon :value="getOption('custom_post_item_data.highlight_type')" @input="setOption('custom_post_item_data.highlight_type',$event)" :options="highlightTypeList" />
                </to-panel-group>
                ...
                <to-panel-group :label-title="$t('panel.highlight_style')">
                    ...
                    <to-radio-icon :value="getOption('custom_post_item_data.highlight_style')" @input="setOption('custom_post_item_data.highlight_style',$event)" :options="highlightStyleList" />
                </to-panel-group>

                <to-panel-group v-if="getOption('custom_post_item_data.highlight_style') == 'alternative'" :label-title="$t('panel.highlight_alternative_colors')">
                    <template v-slot:tooltip>
                        <div class="help-tooltip-text">
                            <div class="info">
                    ...
                    <div class="to-changed-settings">
                        <div class="form-grid">
                            <div class="col-4 col-tb-2">
                                <to-color-picker
                                    :value="getOption('custom_post_item_data.highlight_title_left_background')"
                                    @input="setOption('custom_post_item_data.highlight_title_left_background',$event)"
                                    :label-title="$t('colors.highlight_title_left_background')"/>
                            </div>
                            <div class="col-4 col-tb-2">
                                <to-color-picker
                                    :value="getOption('custom_post_item_data.highlight_title_left_color')"
                                    @input="setOption('custom_post_item_data.highlight_title_left_color',$event)"
                                    :label-title="$t('colors.highlight_title_left_color')"/>
                            </div>
                            <div class="col-4 col-tb-2">
                                <to-color-picker
                                    :value="getOption('custom_post_item_data.highlight_title_right_background')"
                                    @input="setOption('custom_post_item_data.highlight_title_right_background',$event)"
                                    :label-title="$t('colors.highlight_title_right_background')"/>
                            </div>
                            <div class="col-4 col-tb-2">
                                <to-color-picker
                                    :value="getOption('custom_post_item_data.highlight_title_right_color')"
                                    @input="setOption('custom_post_item_data.highlight_title_right_color',$event)"
