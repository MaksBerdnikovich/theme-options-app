...
return array(
    ...
    'info' => array (
        ...
        'single_pages_post_layout_source' => __('TheGem includes built-in settings for blog posts as well as templates builder, allowing you to create blog post templates with page builder. Here you can specify, which type of layout settings to use globally across your blog posts. You can also specify the type of layout settings to use for individual blog posts in page options of this blog posts separately.', 'thegem'),
        ...
        'single_pages_post_custom_layout_source' => __('TheGem includes built-in settings for posts as well as templates builder, allowing you to create post templates with page builder. Here you can specify, which type of layout settings to use globally across your posts. You can also specify the type of layout settings to use for individual posts in page options of this posts separately.', 'thegem'),
        ...
        'single_pages_page_layout_source' => __('TheGem includes built-in settings for pages as well as templates builder, allowing you to create page templates with page builder. Here you can specify, which type of layout settings to use globally across your pages. You can also specify the type of layout settings to use for individual pages in page options of this page separately.', 'thegem'),
        ...
        'single_pages_portfolio_layout_source' => __('TheGem includes built-in layout settings for portfolio pages as well as templates builder, allowing you to create portfolio page templates with page builder. Here you can specify, which type of layout settings to use globally across your portfolio pages. You can also specify the type of layout settings to use for individual portfolio pages in page options of this portfolio pages separately.', 'thegem'),
        ...
        'archive_pages_blog_archive_layout_source' => __('TheGem includes flexible built-in settings for blog archives list/grid with many configuration options as well as templates builder, allowing you to create blog archive templates with page builder. Here you can specify, which type of layout settings to use globally across your blog archives. You can also specify the type of layout settings to use for individual blog archive pages in page options of this archives separately.', 'thegem'),
        ...
        'archive_pages_custom_archive_layout_source' => __('TheGem includes flexible built-in settings for archives list/grid with many configuration options as well as templates builder, allowing you to create archive templates with page builder. Here you can specify, which type of layout settings to use globally across your archives. You can also specify the type of layout settings to use for individual archive pages in page options of this archives separately.', 'thegem'),
        ...
        'archive_pagination_reduce_html' => __('By activating this setting you can reduce the HTML size of the page with the grid by specifying the number of grid items to be load on initial page load. The rest of the items will be AJAX loaded on user scroll. Reducing the page HTML size improves the performance.', 'thegem'),
        ...
        'p_options_archive_layout_settings' => __('<p><b>Default Settings:</b> inherit archive layout settings from Theme Options.<br/><br/><b>Custom Settings:</b> apply individual archive layout settings for this post.</p>', 'thegem'),
        'p_options_post_layout_settings' => __('<p><b>Default Settings:</b> inherit post layout settings from Theme Options.<br/><br/><b>Custom Settings:</b> apply individual post layout settings for this post.</p>', 'thegem'),
        ...
        'p_options_page_layout_settings' => __('<p><b>Default Settings:</b> inherit page layout settings from Theme Options.<br/><br/><b>Custom Settings:</b> apply individual page layout settings for this page.</p>', 'thegem'),
        ...
        'p_options_portfolio_layout_settings' => __('<p><b>Default Settings:</b> inherit portfolio page layout settings from Theme Options.<br/><br/><b>Custom Settings:</b> apply individual portfolio page layout settings for this portfolio page.</p>', 'thegem'),
    ...
    'panel' => array(
        ...
        'portfolio_builder' => __('Portfolio Item Builder', 'thegem'),
        'portfolio_builder_previews' => __('Preview Portfolio for Templates Builder', 'thegem'),
    ...
    'popups' => array(
        ...
        'unique_id' => __('Use this unique ID to trigger popup', 'thegem'),
